...
public class TotpServiceImplTest {
    ...
    void setUp() {
        ...
        this.totpService = (TOTPService) AuthenticationServiceBuilder.buildService(AuthType.TOTP, client, authParams);
    }
    ...
    void signUp() {
        ...
        doReturn(Mockito.mock(TOTPResponse.class)).when(apiProxy).post(any(), any(), any());
    ...
    @Test
    public void testUpdateUserForEmptyLoginId() {
        ServerCommonException thrown =
                assertThrows(
                        ServerCommonException.class,
                        () -> totpService.updateUser(null));
        ...
        try (MockedStatic<ApiProxyBuilder> mockedApiProxyBuilder = mockStatic(ApiProxyBuilder.class)) {
            ...
            HttpRequest httpRequest =
                    HttpRequest.newBuilder()
                            ...
                            .build();
            TOTPResponse updateUserEmail =
                    totpService.updateUser(MOCK_EMAIL);
