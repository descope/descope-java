...
class AccessKeyServiceImplTest {
    ...
    private final AccessKeyResponse mockResponse = AccessKeyResponse.builder().keyTenants(mockKeyTenants)
            .name("name").roleNames(mockRoles).id("id").createdBy("TestUSer").createdTime(123456789023L).build();
    ...
    void setUp() {
        ...
        this.accessKeyService = ManagementServiceBuilder.buildServices(client, authParams).getAccessKeyService();
    }
    ...
    void testCreateForEmptyName() {
        ServerCommonException thrown =
                assertThrows(
                        ServerCommonException.class, () -> accessKeyService.create("", 10, mockRoles, mockKeyTenants));
    ...
    void testLoadForEmptyId() {
        ServerCommonException thrown =
                assertThrows(
                        ServerCommonException.class, () -> accessKeyService.load(""));
        assertNotNull(thrown);
    ...
    void testUpdateForEmptyName() {
        ServerCommonException thrown =
                assertThrows(
                        ServerCommonException.class, () -> accessKeyService.update("Id", ""));
        assertNotNull(thrown);
        assertEquals("The Name argument is invalid", thrown.getMessage());
    }
    ...
    void testUpdateForEmptyId() {
        ServerCommonException thrown =
                assertThrows(
                        ServerCommonException.class, () -> accessKeyService.update("", "Krishna"));
        assertNotNull(thrown);
        assertEquals("The Id argument is invalid", thrown.getMessage());
    }
    ...
    void testDeactivateForEmptyId() {
        ServerCommonException thrown =
                assertThrows(
                        ServerCommonException.class, () -> accessKeyService.deactivate(""));
        assertNotNull(thrown);
        assertEquals("The Id argument is invalid", thrown.getMessage());
    }
    ...
    void testActivateForEmptyId() {
        ServerCommonException thrown =
                assertThrows(
                        ServerCommonException.class, () -> accessKeyService.activate(""));
        assertNotNull(thrown);
        assertEquals("The Id argument is invalid", thrown.getMessage());
    }
    ...
    void testDeleteForEmptyId() {
        ServerCommonException thrown =
                assertThrows(
                        ServerCommonException.class, () -> accessKeyService.delete(""));
        assertNotNull(thrown);
        assertEquals("The Id argument is invalid", thrown.getMessage());
    }
