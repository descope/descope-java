...
public class Routes {
  ...
  public static class ManagementEndPoints {
    ...
    // Group
    public static final String GROUP_LOAD_ALL_LINK = "/mgmt/group/all";
    public static final String LOAD_ALL_FOR_GROUP_MEMBERS_LINK = "/mgmt/group/member/all";
    public static final String LOAD_ALL_GROUP_MEMBERS_LINK = "/mgmt/group/members";
    ...
    // Access key
    public static final String MANAGEMENT_ACCESS_KEY_CREATE_LINK = "/mgmt/accesskey/create";
    public static final String MANAGEMENT_ACCESS_KEY_LOAD_LINK = "/mgmt/accesskey";
    public static final String MANAGEMENT_ACCESS_KEY_SEARCH_ALL_LINK = "/mgmt/accesskey/search";
    public static final String MANAGEMENT_ACCESS_KEY_UPDATE_LINK = "/mgmt/accesskey/update";
    public static final String MANAGEMENT_ACCESS_KEY_DEACTIVATE_LINK = "/mgmt/accesskey/deactivate";
    public static final String MANAGEMENT_ACCESS_KEY_ACTIVE_LINK = "/mgmt/accesskey/activate";
    public static final String MANAGEMENT_ACCESS_KEY_DELETE_LINK = "/mgmt/accesskey/delete";

    // Permission
    public static final String MANAGEMENT_PERMISSION_CREATE_LINK = "/mgmt/permission/create";
    public static final String MANAGEMENT_PERMISSION_UPDATE_LINK = "/mgmt/permission/update";
    public static final String MANAGEMENT_PERMISSION_DELETE_LINK = "/mgmt/permission/delete";
    public static final String MANAGEMENT_PERMISSION_LOAD_ALL_LINK = "/mgmt/permission/all";

    // Roles
    public static final String MANAGEMENT_ROLES_CREATE_LINK = "/mgmt/role/create";
