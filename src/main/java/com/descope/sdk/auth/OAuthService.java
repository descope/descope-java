...
public interface OAuthService {
     ...
     * @return a string represent the redirect URL
     */
    String startSignIn(String provider, String returnURL, LoginOptions loginOptions) throws DescopeException;
     ...
     * @return a string represent the redirect URL
     */
    String startSignUp(String provider, String returnURL, LoginOptions loginOptions) throws DescopeException;
