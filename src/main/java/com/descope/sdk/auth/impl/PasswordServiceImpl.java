...
public class PasswordServiceImpl extends AuthenticationServiceImpl
  ...
  public AuthenticationInfo signUp(String loginId, User user, String password) throws DescopeException {
    ...
    var pwdSignUpRequest = AuthenticationPasswordSignUpRequestBody.builder().loginId(loginId)
        .user(user)
        .password(password)
        .build();
    var apiProxy = getApiProxy();
    JWTResponse jwtResponse = apiProxy.post(getUri(SIGNUP_PASSWORD), pwdSignUpRequest, JWTResponse.class);
  ...
  public AuthenticationInfo signIn(String loginId, String password) throws DescopeException {
    ...
    var pwdSignInRequest = AuthenticationPasswordSignInRequestBody.builder().loginId(loginId)
        .password(password)
        .build();
    var apiProxy = getApiProxy();
    JWTResponse jwtResponse = apiProxy.post(getUri(SIGNIN_PASSWORD), pwdSignInRequest, JWTResponse.class);
    return getAuthenticationInfo(jwtResponse);
  }
  ...
  public void sendPasswordReset(String loginId, String redirectURL) throws DescopeException {
    ...
    var pwdResetRequest = AuthenticationPasswordResetRequestBody.builder().loginId(loginId)
  ...
  public void updateUserPassword(String loginId, String newPassword) throws DescopeException {
    ...
    var pwdUpdateRequest = AuthenticationPasswordUpdateRequestBody.builder().loginId(loginId)
  ...
  public void replaceUserPassword(String loginId, String oldPassword, String newPassword) throws DescopeException {
    ...
    var pwdUpdateRequest = AuthenticationPasswordReplaceRequestBody.builder().loginId(loginId)
