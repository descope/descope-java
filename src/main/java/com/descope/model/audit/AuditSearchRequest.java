...
public class AuditSearchRequest {
  ...
  /** List of devices to filter by. Current devices supported are "Bot"/"Mobile"/"Desktop"/"Tablet"/"Unknown" */
  List<String> devices;
  /** List of methods to filter by. Current auth methods are "otp"/"totp"/"magiclink"/"oauth"/"saml"/"password" */
  List<String> methods;
