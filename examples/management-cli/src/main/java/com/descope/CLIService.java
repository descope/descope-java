...
final class CLIService {
  ...
  public void createAccessKey(
    ...
    System.out.printf(
        "Access key with Id: %s was successfully Created%n", accessKeyResponse.getId());
  }
  ...
  public void updateAccessKey(String keyId, String keyName) {
    ...
    System.out.printf(
        "Access key with Id: %s was successfully updated%n", accessKeyResponse.getId());
  }
  ...
  public void deleteAccessKey(String keyId) {
    ...
    System.out.printf(
        "Access key with keyId: %s was successfully deleted%n", accessKeyResponse.getId());
  }
  ...
  public void loadAccessKey(String keyId) {
    ...
    System.out.printf(
        "Access key with Id: %s was successfully loaded%n", accessKeyResponse.getId());
  }
